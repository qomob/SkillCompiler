...
[![Version](https://img.shields.io/badge/Version-v3.2.1-green.svg)](https://github.com/qomob/SkillCompiler)
...
| 质量保障 | 无 | 靠经验 | General 五层评估闭环；Creative 五层诚实评估（L3 风格保真/AI 腔率/Novelty/Revision Gain，L4 LLM Preference Proxy，L5 真人偏好可选） |
...
| **C3 Design** | ✅ 总是* | 判断回路设计（Judge dimensions/weighting + Revision 策略）+ Runtime Profile → 产出 Creative IR（[schema](schemas/creative-ir-schema.json)） |
